      ...
      if (getxy) {
        ...
        if (xymeasCur) {
	      ...
	      if (savedata) {
	        ...
	        if (issp && exportsp) {
	          savedata_opts$outsp_fmt <- ifelse(out_fmt == "csv", "shp", out_fmt)
	          savedata_opts$out_layer <- xynm
            ...
            if (!append_layer) {
	          ...
	          savedata_opts$out_layer <- "spconddat"
      ...
      if (is.null(sccmnm)) {
        ...
        if (is.null(sccmx) || nrow(sccmx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "subp_cond_chng_mtrx"
            datExportData(sccmx, 
            ...
            if (is.null(grmnm)) {
              ...
              if (is.null(grmx) || nrow(grmx) == 0) {
                ...
                if (savedata) {
                  ...
                  savedata_opts$out_layer <- "tree_grm_component"
                  datExportData(grmx, 
              ...
              if (is.null(grmbx) || nrow(grmbx) == 0) {
                ...
                if (savedata) {
                  ...
                  savedata_opts$out_layer <- "tree_grm_begin"
                  datExportData(grmbx, 
              ...
              if (is.null(grmmx) || nrow(grmmx) == 0) {
                ...
                if (savedata) {
                  ...
                  savedata_opts$out_layer <- "tree_grm_midpt"
                  datExportData(grmmx, 
...
#            seedx <- DT_NAto0(seedx, seednavars)
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "seedling"
            datExportData(seedx, 
      ...
      if (!is.null(vsubpsppnm)) {
        ...
        if (is.null(p2veg_subplot_sppx) || nrow(p2veg_subplot_sppx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "p2veg_subplot_spp"
      ...
      if (!is.null(vsubpstrnm)) {
        ...
        if (is.null(p2veg_subp_structurex) || nrow(p2veg_subp_structurex) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "p2veg_subp_structure"
      ...
      if (!is.null(invsubpnm)) {
        ...
        if (is.null(invasive_subplot_sppx) || nrow(invasive_subplot_sppx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "invasive_subplot_spp"
      ...
      if (!is.null(subplotnm)) {
        ...
        if (is.null(subpx) || nrow(subpx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "subplot"
            datExportData(subpx, 
      ...
      if (!is.null(subpcondnm)) {
        ...
        if (is.null(subpcx) || nrow(subpcx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "subp_cond"
      ...
      if (is.null(dwmnm)) {
        ...
        if (is.null(cond_dwm_calcx) || nrow(cond_dwm_calcx) == 0) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- "cond_dwm_calc"
      ...
      for (j in 1:length(othertables2)) {
        ...
        if (!is.null(otab)) {
          ...
          if (savedata) {
            ...
            savedata_opts$out_layer <- tolower(othertable)
    ...
    if ((savedata || !treeReturn) && !is.null(pltx)) {
      ...
      if (savedata && savePOP && !is.null(ppsax)) {
        ...
        savedata_opts$out_layer <- "pop_plot_stratum_assgn"
        datExportData(ppsax, 
      ...
      if (savePOPall && !"pop_stratum" %in% othertables) {
        ...
        savedata_opts$out_layer <- "pop_stratum"
      ...
      if (savePOPall && !"pop_estn_unit" %in% othertables) {
        ...
        savedata_opts$out_layer <- "pop_estn_unit"
  ...
  if (savedata) {
    ...
    savedata_opts$out_layer <- "ref_species"
  ...
  if (savedata && saveSURVEY) {
    ...
    savedata_opts$out_layer <- "survey"
  ...
  if (savedata && !is.null(pltcnt)) {
    ...
    savedata_opts$out_layer <- "pltcnt"
