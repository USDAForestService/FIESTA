...
```{r}
condsum <- datSumCond(cond=WYcond, plt=WYplt, 
...
```{r}
treesumdat4a <- datSumTree(WYtree, plt=WYplt, tsumvarlst="TPA_UNADJ",
...
```{r}
treesumdat4c <- datSumTree(WYtree, plt=WYplt, cond=WYcond, tsumvarlst="VOLCFNET",
...
```{r}
treesumdat5a <- datSumTree(WYtree, plt=WYplt, seed=WYseed, tsumvarlst="TPA_UNADJ",
