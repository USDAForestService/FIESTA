...
#     bysubp = FALSE, subpid = "SUBP", tsumvarlst = NULL, tsumvarnmlst = NULL,  
#     TPA = TRUE, tfun = sum, ACI = FALSE, tfilter = NULL, lbs2tons = TRUE,   
#     getadjplot = FALSE, adjtree = FALSE, adjTPA = 1, NAto0 = TRUE, savedata = FALSE,
#     outfolder = NULL, out_layer = NULL, outfn.date = TRUE, overwrite = TRUE,
#     tround = 6, checkNA = FALSE, returnDT = TRUE) 
# 
# Description:
...
#     tfun = sum, ACI = FALSE, tfilter = NULL, lbs2tons = TRUE, tdomvar = "SPCD",  
#     tdomvarlst = NULL, tdomvar2 = NULL, tdomvarl2lst = NULL, tdomprefix = NULL, 
#     tdombarplot = FALSE, tdomtot = FALSE, tdomtotnm = NULL, FIAname = FALSE, 
#     addseed = FALSE, presence = FALSE, proportion = FALSE, cover = FALSE, 
#     getadjplot = FALSE, adjtree = FALSE, NAto0 = TRUE, adjtpa = 1, savedata = FALSE,
#     outfolder = NULL, out_layer = NULL, outfn.date = TRUE, overwrite = FALSE,
#     tround = 6, checkNA = FALSE, returnDT = TRUE) 
# 
# Description:
