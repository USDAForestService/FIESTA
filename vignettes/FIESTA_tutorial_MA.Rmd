...
unitlut <- modeldat$unitzonal # not sure if this is right...
...
# MApopdat.ht <- modMApop(popTabs = list(tree=WYtree, cond=WYcond),
#                         pltassgn=pltassgn, 
#                         adj="samp", 
#                         unitarea=unitarea,
#                         unitvar=unitvar)
...
modMApop(popTabs = popTables(tree = WYtree, cond = WYcond),
         pltassgn = pltassgn, adj = "samp", unitarea = unitarea,
         unitvar = unitvar, unitzonal = unitlut)
