...
```{r}
MApopdat <- modMApop(popTabs = list(tree = WYtree, 
                                    cond = WYcond, 
                                    plt = WYplt),
                     auxdat = modeldat)
```
...
In this example, we look at estimating the area of forest land in Wyoming from 2011 to 2013 with the generalized regression estimator (`MAmethod = "greg"`). `FIESTA` returns raw data for area of forest land, Wyoming, 2011-2013 (sum estimation units). 
