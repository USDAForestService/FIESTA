...
source("C:\\_tsf\\_GitHub\\FIESTA\\R\\datExportData.R")
source("C:\\_tsf\\_GitHub\\FIESTA\\R\\spExportSpatial.R")
source("C:\\_tsf\\_GitHub\\FIESTA\\R\\spGetStrata.R")
...
GBpopdat <- modGBpop(
  ...
  strata_opts = list(getwt = TRUE)              # strata options
  )
