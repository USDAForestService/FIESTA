...
########################################################################################
GBpopdat <- modGBpop(cond=WYcond, tree=WYtree, seed=WYseed, 
    pltassgn=WYpltassgn, pltassgnid="CN", 
...
GBpopdat$treex <- datLUTclass(x=GBpopdat$treex, xvar="DIA", cutbreaks=treedia.brks)$xLUT
head(GBpopdat$treex)
table(GBpopdat$treex$DIACL)

# Get number of live trees by species and diameter class
tree11 <- modGBtree(GBpopdat=GBpopdat, landarea="FOREST", 
...
tree11b <- modGBtree(GBpopdat=GBpopdat, estseed="add", landarea="FOREST", 
  estvar="TPA_UNADJ", estvar.filter="STATUSCD==1", rowvar="SPCD", row.FIAname=TRUE, 
  colvar="DIACL", sumunits=TRUE, rawdata=TRUE)
names(tree11b)
tree11b$est
