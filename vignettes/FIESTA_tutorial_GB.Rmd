...
#   strata = TRUE, stratalut = NULL, strvar = "STRATUMCD", getwt = TRUE,    
#   getwtvar = "P1POINTCNT", stratcombine = TRUE, minplotnum.strat = 2,   
#   saveobj = FALSE, savedata = FALSE, outfolder = NULL, out_fmt = "csv",   
#   out_dsn = NULL, outfn.pre = NULL, outfn.date = TRUE, overwrite_dsn = FALSE,  
