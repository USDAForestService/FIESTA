...
SAdomdat <- spGetSAdoms(smallbnd=WYbhdistfn, smallbnd.unique="DISTRICTNA",
        helperbnd=ecomap, helperbnd.unique="SUBSECTION", largebnd=ecomap,
        largebnd.unique="SECTION", nbrdom.min=10)
...
SAdata <- spGetPlots(bnd=SAdoms, datsource="sqlite", 
      data_dsn=SQLitefn, xy="PLOT", xy_dsn=SQLitefn, xvar="LON", yvar="LAT", 
      xy.uniqueid="CN", invyrs=2011:2013, showsteps=TRUE, xy.joinid="CN")
