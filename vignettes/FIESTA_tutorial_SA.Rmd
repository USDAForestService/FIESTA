...
This currently grabs all predictors for the unit and none for the area.
...
#### Example 9: Basal area of live trees (at least 5 inches diameter)

We can also use different response variables to estimate, and in this example we chose basal area. 
...
#### Example 10: Basal area of live trees (at least 5 inches diameter), saving to an outfolder
...
#### Example 11: Basal area of live trees (at least 5 inches diameter), HB model
