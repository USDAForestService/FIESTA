...
##################################################################################
WYdata.periodic <- DBgetPlots(states="Wyoming", invtype="PERIODIC", allyrs=TRUE)
...
## Get plots that have pinyon pine trees in Utah and Colorado
utcoplts.tree106 <- DBgetPlots(states=c("Utah", "Colorado"), measCur=TRUE, istree=TRUE, 
            alltFilter="SPCD == 106")
dim(utcoplts.tree106)
dim(utcoplts.tree106)
dim(utcoplts.tree106)
