---
title: "Photo-Based Estimators"
output: rmarkdown::html_vignette
description: >
  Learn how to calculate population estimates and their sampling errors using photo-based estimators from Patterson (2012)
vignette: >
  %\VignetteIndexEntry{Photo-Based Estimators}
...
chgcover1 <- 
  modPB(PBpopdat = PBpoparea, 
        ...
        colvar = "cover_1",
        nonsamp.pntfilter = "cover_1 != 999",
        table_opts = list(rowlut = changelut, 
                          collut = icecover_1),  
...
```{r}
cover12 <- 
  modPB(PBpopdat = PBpoparea_nonPS,
		    rowvar = "cover_1", 
		    colvar = "cover_2", 
        nonsamp.pntfilter = "cover_1 != 999",
		    table_opts = list(rowlut = icecover_1,
