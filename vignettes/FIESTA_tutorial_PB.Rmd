...
cover1 <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		...
		pnt.nonsamp.filter="cover_1 != 999")
names(cover1)
cover1$est
...
cover1.area <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
		pnt.nonsamp.filter="cover_1 != 999", tabtype="AREA", unitarea=sum(unitarea$ACRES))
cover1.area$est
...
cover1 <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
		pnt.nonsamp.filter="cover_1 != 999", rawdata=TRUE)
names(cover1)
cover1$est
...
cover1 <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
		pnt.nonsamp.filter="cover_1 != 999", rawdata=TRUE, savedata=TRUE, outfolder=outfolder)
names(cover1)
cover1$est
cover1.raw <- cover1$raw
names(cover1.raw)
...
chg_ag <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
...
chg_ag.area <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="chg_ag_2", rowlut=icechg_ag, rawdata=TRUE, title.rowvar="Agent of Change",
...
chg_ag.plts <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="chg_ag_2", rowlut=icechg_ag, rawdata=TRUE, title.rowvar="Agent of Change",
...
chg_ag.pnts <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="chg_ag_2", rowlut=icechg_ag, rawdata=TRUE, title.rowvar="Agent of Change",
...
# Note: Add a landarea filter to subset dataset to only plots with observed change.
landarea.filter <- "change_1_2 == 1"
chg_ag.plts.area <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="chg_ag_2", rowlut=icechg_ag, rawdata=TRUE, title.rowvar="Agent of Change",
...
# Note: Add a point filter to include observed change on points
pnt.filter <- "chg_ag_2 > 0"
chg_ag.pnts.area <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="chg_ag_2", rowlut=icechg_ag, rawdata=TRUE, title.rowvar="Agent of Change",
		pnt.filter=pnt.filter, returntitle=TRUE, title.filter="observed changed", 
...
chg_ag_cover1 <- modPB(pnt=icepnt, pntid="dot_cnt", rowvar="chg_ag_2", 
...
chg_ag_cover1.acres <- modPB(pnt=icepnt, pntid="dot_cnt", rowvar="chg_ag_2", 
...
chg_ag_cover2 <- modPB(pnt=icepnt, pntid="dot_cnt", rowvar="chg_ag_2", 
    rowlut=icechg_ag, colvar="cover_2", collut=icecover_2, rawdata=TRUE, 
...
cover1.unit.area <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id",  
    pntid="dot_cnt", rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
    pnt.nonsamp.filter="cover_1 != 999", tabtype="AREA", unitarea=unitarea, unitvar="ESTN_UNIT", 
    areavar="ACRES")
...
cover1.unitsum2 <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
		pnt.nonsamp.filter="cover_1 != 999", tabtype="AREA", unitarea=unitarea, 
...
# Return raw data
# Note: Estimates are generated by ESTN_UNIT and summed to the population.
cover1.unitsum.area <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, title.rowvar="Land Cover (2011)", 
		pnt.nonsamp.filter="cover_1 != 999", tabtype="AREA", unitarea=unitarea, 
		unitvar="ESTN_UNIT", areavar="ACRES", sumunits=TRUE, rawdata=TRUE)
...
cover12 <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		...
		pnt.nonsamp.filter="cover_1 != 999", returntitle=TRUE)
names(cover12)
...
cover12.acres <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, colvar="cover_2", collut=icecover_2, 
		rawdata=TRUE, title.rowvar="Land Cover (2011)", title.colvar="Land Cover (2012)", 
		pnt.nonsamp.filter="cover_1 != 999", tabtype="AREA", unitarea=sum(unitarea$ACRES))
names(cover12.acres)
...
cover12nm <- modPB(pnt=icepnt2, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
...
cover12.lt200 <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, colvar="cover_2", collut=icecover_2, 
		rawdata=TRUE, title.rowvar="Land Cover (2011)", title.colvar="Land Cover (2012)", 
		pnt.nonsamp.filter="cover_1 != 999", pnt.filter="cover_1 < 200", 
...
cover12b <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, colvar="cover_2", collut=icecover_2, 
		rawdata=TRUE, title.rowvar="Land Cover (2011)", title.colvar="Land Cover (2014)", 
		pnt.nonsamp.filter="cover_1 != 999", gainloss=TRUE)
names(cover12b)
...
chgcover1 <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		...
		collut=icecover_1, pnt.nonsamp.filter="cover_1 != 999", rawdata=TRUE, 
		title.rowvar="Change")
chgcover1$est
chgcover1$pse
...
chg_ag_cover1.rat <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		...
		rawdata=TRUE, pnt.nonsamp.filter="cover_1 != 999", title.rowvar="Change agent", 
...
cover1_2.rat <- modPB(pnt=icepnt, puniqueid="plot_id", pntid="dot_cnt",
		...
		rawdata=TRUE, pnt.nonsamp.filter="cover_1 != 999", title.rowvar="Land cover (2011)", 
...
cover12ps <- modPB(pnt=icepnt, pltassgn=iceplt, pltassgnid="plot_id", pntid="dot_cnt",
		rowvar="cover_1", rowlut=icecover_1, colvar="cover_2", collut=icecover_2, 
