...
#######################################################################################
# Usage:
# modPBpop(pnt = NULL, pltpct = NULL, plotid = "plot_id", pntid = NULL, 
#	    pltpctvars = NULL, plt = NULL, pltassgn = NULL, puniqueid = "CN", 
#	    pltassgnid = "CN", plt.nonsamp.filter = NULL, tabtype = "PCT", strata = FALSE, 
#    	sumunits = FALSE, unitvar = NULL, unitvar2 = NULL, unitarea = NULL, 
#   	areavar = "ACRES", unitcombine = FALSE, stratalut = NULL, strvar = "STRATUMCD", 
#   	getwt = TRUE, getwtvar = "P1POINTCNT", stratcombine = TRUE, pvars2keep = NULL, 
#   	gui = FALSE)
# 
# Description:
