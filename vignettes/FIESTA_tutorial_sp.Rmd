...
We can extract public coordinates within WY Bighorn NF boundary, returning spatial (spxy) and nonspatial coordinates (xyids).
...
Or, returning only nonspatial coordinates (xyids).
