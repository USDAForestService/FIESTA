...
#   seed_layer = "seed", ppsa_layer = "pop_plot_stratum_assgn", other_layers = NULL,  
#   puniqueid = "CN", savePOP = FALSE, evalid = NULL, evalCur = FALSE, evalEndyr = NULL,  
#   evalType = "VOL", measCur = FALSE, measEndyr = NULL, measEndyr.filter = NULL, 
