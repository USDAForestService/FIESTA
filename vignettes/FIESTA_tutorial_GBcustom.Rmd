...
######################################################################################
stratdat.bh2 <- spGetStrata(xyplt=WYplt, uniqueid="CN", 
    xvar="LON_PUBLIC", yvar="LAT_PUBLIC", prj="longlat", datum="NAD83", 
    unit_layer=WYbhfn, strat_layer=fornffn)
    
source("C:\\_tsf\\_GitHub\\FIESTA\\R\\spGetAuxiliary.R")
stratdat.bh <- spGetAuxiliary(xyplt=WYplt, uniqueid="CN", 
    xvar="LON_PUBLIC", yvar="LAT_PUBLIC", prj="longlat", datum="NAD83", 
    dunit_layer=WYbhfn, dunitvar=NULL, rastlst.cat=fornffn, rastlst.cat.name="STRATUMCD",
    strvars="STRATUMCD")
    
source("C:\\_tsf\\_GitHub\\FIESTA\\R\\spGetAuxiliary.R")
stratdat.bh <- spGetAuxiliary(xyplt=WYplt, uniqueid="CN", 
    xvar="LON_PUBLIC", yvar="LAT_PUBLIC", prj="longlat", datum="NAD83", 
    dunit_layer=WYbhfn, dunitvar=NULL, rastlst.cat=fornffn,
    strvars=fornffn, rastlst.cat.name="STRATUMCD")


names(stratdat.bh)
pltassgn.bh <- stratdat.bh$pltassgn
dunitarea.bh <- stratdat.bh$dunitarea
...
## Create barplot
datBarplot(voldead.bh$raw$unit_rowest, xvar=titlelst$title.rowvar, yvar="est")
...
dat <- datLUTclass(x=GBpopdat.bh$treex, xvar="DIA", LUT=ref_diacl2in, LUTclassnm="DIACL2IN")
GBpopdat.bh$treex <- dat$xLUT
LUT <- dat$LUT

sgrprat.bh <- modGBratio(GBpopdat=GBpopdat.bh, landarea="FOREST", 
