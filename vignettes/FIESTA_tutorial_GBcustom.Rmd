...
#   pfilter = NULL, cfilter = NULL, rowvar = NULL, colvar = NULL,   
...
#   strwtvar = "P1POINTCNT", stratcombine = TRUE, landarea="FOREST", pfilter = NULL,  
#   cfilter = NULL, ratiotype = "PERACRE", estvarn = NULL, estvarn.filter = NULL, 
