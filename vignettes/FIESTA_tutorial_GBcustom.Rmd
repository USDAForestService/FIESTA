...
WYdata <- system.file("extdata", "WYdat_eval2013.sqlite", package="FIESTA")
...
#   	unit_layer = NULL, unit_dsn = NULL, unitvar = NULL, areavar= NULL, 
#     areaunits = "ACRES", rast.NODATA = NULL, keepNA = FALSE, showext = TRUE, 
#     savedata = FALSE, exportsp = FALSE, exportNA = FALSE, outfolder = NULL, 
#     out_fmt = "shp", out_dsn = NULL, out_layer = "unit_assgn", outfn.date = TRUE,
#     outfn.pre = NULL, overwrite = FALSE, ...) 
# 
# Description:
...
unitdat.bhdist <- spGetEstUnit(xyplt=WYplt, uniqueid="CN", xvar="LON_PUBLIC", yvar="LAT_PUBLIC", 
    crs=4269, unit_layer=WYbhdistfn, unitvar="DISTRICTNA")
...
#     unit_layer = NULL, unit_dsn = NULL, unitvar = NULL, strattype = "RASTER", 
#     strat_layer = NULL, strat_dsn = NULL, strvar = NULL, strat_lut = NULL,
#   	areaunits = "ACRES", rast.NODATA = NULL, keepNA = FALSE, showext = TRUE,
#     savedata = FALSE, exportsp = FALSE, exportNA = FALSE, outfolder = NULL,
#     out_fmt = "shp", out_dsn = NULL, out_layer = "strat_assgn", outfn.date = TRUE,
#     outfn.pre = NULL, overwrite = FALSE, ...) 
# 
# Description:
...
# Get estimation unit acres and strata information for Bighorn National Forest.
######################################################################################
stratdat.bh <- spGetStrata(xyplt=WYplt, uniqueid="CN", xvar="LON_PUBLIC", yvar="LAT_PUBLIC", 
...
######################################################################################
stratdat.bhdist <- spGetStrata(xyplt=WYplt, uniqueid="CN", xvar="LON_PUBLIC", yvar="LAT_PUBLIC", 
...
#   condid = "CONDID", puniqueid = "CN", pltassgnid = "CN", sumunits = FALSE, 
#   adjsamp = TRUE, strata = TRUE, landarea = "ALL", ACI = FALSE, 
#   plt.nonsamp.filter = NULL, cond.nonsamp.filter = NULL, plt.filter = NULL, 
#   cond.filter = NULL, unitarea = NULL, unitvar = NULL, unitvar2 = NULL,
...
#   pseround = 2, estnull = 0, psenull = "--", divideby = NULL, savedata = FALSE, 
...
area.bh <- modGBarea(cond=WYcond, pltassgn=pltassgn.bh, pltassgnid="CN", 
    rowvar="FORTYPCD", colvar="STDSZCD", unitvar=unitvar.bh, strvar=strvar.bh, 
    unitarea=unitarea.bh, stratalut=stratalut.bh, areavar=areavar.bh, getwt=FALSE, 
...
## population data
area.bh.GBpopdat <- area.bh$GBpopdat
names(area.bh.GBpopdat)

area.bh.GBpopdat$strlut
...
area.bhdist <- modGBarea(cond=WYcond, pltassgn=pltassgn.bhdist, pltassgnid="CN",
    sumunits=FALSE, rowvar="FORTYPCD", colvar="STDSZCD", col.FIAname=TRUE, 
    unitvar=unitvar.bhdist, strvar=strvar.bhdist, unitarea=unitarea.bhdist, 
    stratalut=stratalut.bhdist, areavar=areavar.bhdist, getwt=FALSE, 
    rawdata=TRUE, returntitle=TRUE, title.ref="Bighorn National Forest")
names(area.bhdist)
area.bhdist$est
area.bhdist$pse
...
head(area.bhdist.raw$unit.grpest)
...
#   puniqueid = "CN", pltassgnid = "CN", sumunits = FALSE, adjsamp = TRUE, 
#   strata = TRUE, landarea="FOREST", ACI = FALSE, plt.nonsamp.filter = NULL, 
#   cond.nonsamp.filter = NULL, plt.filter = NULL, cond.filter = NULL, 
#   unitvar = NULL, unitvar2 = NULL, autocombine = TRUE, unitarea = NULL,
#   areavar = "ACRES", stratalut = NULL, strvar = "STRATUMCD", getwt = TRUE,
#   strwtvar = "P1POINTCNT", estvar = NULL, estvar.filter = NULL, estvar.name = NULL, 
...
#   title.colvar = NULL, title.unitvar = NULL, title.estvar = NULL, 
...
balive.bh <- modGBtree(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bh, pltassgnid="CN",
  sumunits=FALSE, rowvar="FORTYPCD", row.FIAname=TRUE, unitvar=unitvar.bh, 
  strvar=strvar.bh, unitarea=unitarea.bh, stratalut=stratalut.bh, areavar=areavar.bh, 
  getwt=FALSE, estvar="BA", estvar.filter="STATUSCD==1", rawdata=TRUE, 
  returntitle=TRUE, title.ref="Bighorn National Forest", savedata=TRUE, 
  outfolder=outfolder)
names(balive.bh)
balive.bh$est
balive.bh$titlelst
...
balive.bhdist <- modGBtree(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bhdist, 
...
balive.bhdist <- modGBtree(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bhdist, 
  pltassgnid="CN", sumunits=FALSE, rowvar="FORTYPCD", row.FIAname=TRUE, 
  unitvar=unitvar.bhdist, strvar=strvar.bhdist, unitarea=unitarea.bhdist, 
  stratalut=stratalut.bhdist, areavar=areavar.bhdist, getwt=FALSE, estvar="BA", 
  estvar.filter="STATUSCD==1", rawdata=FALSE, returntitle=TRUE, 
  title.ref="Bighorn National Forest", title.unitvar="District")
names(balive.bhdist)
balive.bhdist$est
balive.bhdist$pse
balive.bhdist$titlelst
...
tree.bh <- modGBtree(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bh, pltassgnid="CN",
  rowvar="FORTYPCD", colvar="STDSZCD", unitvar=unitvar.bh, strvar=strvar.bh, 
  unitarea=unitarea.bh, stratalut=stratalut.bh, areavar=areavar.bh, getwt=FALSE, 
  estvar="VOLCFNET", estvar.filter="STATUSCD==1", rawdata=TRUE, returntitle=TRUE, 
...
## population data
tree.bh.GBpopdat <- tree.bh$GBpopdat
names(tree.bh.GBpopdat)

tree.bh.GBpopdat$strlut
...
#   plt.nonsamp.filter = NULL, cond.nonsamp.filter = NULL, plt.filter = NULL, 
#   cond.filter = NULL, unitvar = NULL, unitvar2 = NULL, autocombine = TRUE, 
#   unitarea = NULL, areavar = "ACRES", stratalut = NULL, strvar = "STRATUMCD",
#   getwt = TRUE, strwtvar = "P1POINTCNT", estvarn = NULL, estvarn.filter = NULL, 
#   estvarn.name = NULL, estvard = NULL, estvard.filter = NULL, estvard.name = NULL, 
#   rowvar = NULL, rowvar.filter = NULL, colvar = NULL, colvar.filter = NULL, 
#   row.FIAname = FALSE, col.FIAname = FALSE, row.orderby = NULL, col.orderby = NULL, 
#   row.add0 = FALSE, col.add0 = FALSE, rowlut = NULL, collut = NULL, allin1 = FALSE, 
#   estround = 3, pseround = 2, estnull = 0, psenull = "--", divideby = NULL,
#   savedata = FALSE, rawdata = FALSE, outfolder = NULL, outfn = NULL, 
#   outfn.pre = NULL, outfn.date = TRUE, overwrite = TRUE, addtitle = TRUE, 
#   returntitle = FALSE, title.main = NULL, title.ref = NULL, title.rowvar = NULL, 
#   title.colvar = NULL, title.unitvar = NULL, title.estvarn = NULL, 
...
rat.bh <- modGBratio(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bh, pltassgnid="CN", 
  rowvar="FORTYPCD", colvar="STDSZCD", unitvar=unitvar.bh, strvar=strvar.bh, 
  unitarea=unitarea.bh, stratalut=stratalut.bh, areavar=areavar.bh, getwt=FALSE, 
...
## population data
rat.bh.GBpopdat <- rat.bh$GBpopdat
names(rat.bh.GBpopdat)

rat.bh.GBpopdat$strlut


## Look at raw data table
...
## By Bighorn National Forest District ##
# Area by forest type and stand-size class for Bighorn National Forest by district
rat.bhdist <- modGBratio(tree=WYtree, cond=WYcond, pltassgn=pltassgn.bhdist, pltassgnid="CN",
  sumunits=FALSE, rowvar="FORTYPCD", colvar="STDSZCD", unitvar=unitvar.bhdist, 
  strvar=strvar.bhdist, unitarea=unitarea.bhdist, stratalut=stratalut.bhdist, 
  areavar=areavar.bhdist, getwt=FALSE, estvarn="VOLCFNET", estvarn.filter="STATUSCD==1", 
  rawdata=TRUE, returntitle=TRUE, title.ref="Bighorn National Forest", title.unitvar="District")
names(rat.bhdist)
rat.bhdist$est
rat.bhdist$pse
rat.bhdist$titlelst
