...
######################################################################################
GBpopdat.bh <- modGBpop(cond=WYcond, tree=WYtree, pltassgn=pltassgn.bh, pltassgnid="CN", 
...
######################################################################################
GBpopdat.bhdist <- modGBpop(cond=WYcond, tree=WYtree, pltassgn=pltassgn.bhdist, pltassgnid="CN", 
    unitvar=unitvar.bhdist, unitarea=unitarea.bhdist, areavar=areavar.bh, 
    stratalut=stratalut.bhdist, strvar=strvar.bhdist, getwt=FALSE)
names(GBpopdat.bh)

head(GBpopdat.bhdist$condx)
GBpopdat.bhdist$unitarea
GBpopdat.bhdist$unitvar

GBpopdat.bhdist$stratalut
GBpopdat.bhdist$strvar
...
balive.bh <- modGBtree(GBpopdat=GBpopdat.bh, tree=WYtree, cond=WYcond,
  ...
  estvar="BA", estvar.filter="STATUSCD==1", rawdata=TRUE, 
...
tree.bh <- modGBtree(GBpopdat=GBpopdat.bh, tree=WYtree, cond=WYcond, 
  rowvar="FORTYPCD", colvar="STDSZCD", 
...
rat.bh <- modGBratio(GBpopdat=GBpopdat.bh, tree=WYtree, cond=WYcond, 
  rowvar="FORTYPCD", colvar="STDSZCD",  
...
## Look at raw darat.bh.raw <- rat.bh$raw
names(rat.bh.raw)
...
rat.bhdist <- modGBratio(GBpopdat=GBpopdat.bhdist, tree=WYtree, cond=WYcond,  pltassgnid="CN",
  sumunits=FALSE, rowvar="FORTYPCD", colvar="STDSZCD",  
