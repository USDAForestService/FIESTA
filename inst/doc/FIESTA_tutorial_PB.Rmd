...
datBarplot(x=x2, xvar="Land cover (2011)", yvar="est")

datBarplot(x=x2, xvar="Land cover (2011)", yvar="est", ylim=c(0,30), xlabel="Land cover categories",
