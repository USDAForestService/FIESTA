...
The following examples use FIA data from Wyoming for inventory years 2011-2012.
...
#   	outfolder = NULL, outfn = NULL, filternm = NULL, stopifnull=FALSE, gui=FALSE) 
# 
# Description:
...
## Subset trees that are standing dead aspens in WYoming
...
######################################################################################
# Usage:
# datFreq(x, xvar=NULL, total=FALSE, subtotal=FALSE, savedata=FALSE, outfolder=NULL,
# 	  outfn=NULL) 
# 
...
condnf[condnf$PLT_CN == 40404737010690,]
...
######################################################################################
# Usage:
# datSumTree(tree=NULL, plt=NULL, cond=NULL, 
#     tuniqueid="PLT_CN", puniqueid="CN", cuniqueid="PLT_CN", 
#     bycond=FALSE, condid="CONDID", 
#     tsumvarlst=NULL, tsumvarnmlst=NULL, TPA=TRUE, tfun=sum,   
#     ACI=FALSE, tfilter=NULL, lbs2tons=TRUE, 
#     adjtree=FALSE, adjTPA=1,  
#     savedata=FALSE, outfolder=NULL, 
#     outfn=NULL, outfn.date=TRUE, overwrite=TRUE, tround=6) 
# 
# Description:
...
treesum1[treesum1$PLT_CN == 40404758010690,]
treesum2[treesum2$PLT_CN == 40404758010690,]
...
treesum4a[treesum4a$PLT_CN == 40404746010690, ]
treesum4b[treesum4b$PLT_CN == 40404746010690, ]
...
######################################################################################
# Usage:
# datSumTreeDom(tree=NULL, seed=NULL, plt=NULL, cond=NULL, tuniqueid="PLT_CN", 
#     puniqueid="CN", cuniqueid="PLT_CN", bycond=FALSE, condid="CONDID", 
#     tsumvar=NULL, TPA=FALSE, tfun=sum, ACI=FALSE, tfilter=NULL, lbs2tons=TRUE, 
...
#     adjplot="NONE", adjsamp=FALSE, adjTPA=1, savedata=FALSE, outfolder=NULL, 
#     outfn=NULL, outfn.date=TRUE, overwrite=FALSE, tround=6) 
# 
# Description:
# Aggregates tree-level data to plot or condition, including options for
...
tdomdat.tree[tdomdat.tree$PLT_CN == 40404742010690,]
tdomdat.seed[tdomdat.seed$PLT_CN == 40404742010690,]
tdomdat.treeseed[tdomdat.treeseed$PLT_CN == 40404742010690,]
tdomdat.pres[tdomdat.pres$PLT_CN == 40404742010690,]
tdomdat.prop[tdomdat.prop$PLT_CN == 40404742010690,]
tdomdat.cov[tdomdat.cov$PLT_CN == 40404742010690,]
