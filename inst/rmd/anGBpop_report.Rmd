...
rowest <- fread(file.path(rawfolder, rowestfn[length(rowestfn)]))
grpest <- fread(file.path(rawfolder, grpestfn[length(grpestfn)]))
xtab <- fread(file.path(dirname(rawfolder), xtabfn[length(xtabfn)]))
