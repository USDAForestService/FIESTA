...
AOInm <- "Fishlake National Forest"
...
---
title: "Forest Report:  \n `r AOInm`, `r toString(states)`, (`r invyrs2`)"
---
...
![](report_image.png)
Photo from the `r AOInm`, `r toString(states)`. Photo courtesy of `r photo_author`.
...
Table 1. Number of live trees (>= 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 1. Number of live trees (>= 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 2. Number of growing-stock trees (>= 5.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 2. Number of growing-stock trees (>= 5.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 3. Basal area (square feet) of live trees (>= 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 3. Basal area (square feet) of live trees (>= 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 4. Number of live seedlings (< 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 4. Number of live seedlings (< 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 5. Number of live aspen seedlings (< 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 5. Number of live aspen seedlings (< 1.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 6. Net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 6. Net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 7. Net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) per acre by species, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 7. Net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) per acre by species, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 8. Total net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 8. Total net merchantable bole volume (cubic feet) of live trees (>= 5.0 in dia) by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 9. Number of standing dead trees (>= 8.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 9. Number of standing dead trees (>= 8.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 10. Number of standing dead trees (>= 18.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 10. Number of standing dead trees (>= 18.0 in dia) per acre by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 11. Acres of forestland by stand age up to 100 years in 20 year interval classes, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 11. Acres of forestland by stand age up to 100 years in 20 year interval classes, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 12. Acres of forestland by stand age up to 500 years in 20 year interval classes, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 12. Acres of forestland by stand age up to 500 years in 20 year interval classes, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 13. Acres of forest by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 13. Acres of forest by forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 14. Number of live aspen stems by diameter class (0 - <1, 1 - <5, 5 - <8, 8 - <18, 18+ in dia), `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 14. Number of live aspen stems by diameter class (0 - <1, 1 - <5, 5 - <8, 8 - <18, 18+ in dia), `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 15. Number of live aspen stems per acre by diameter class (0 - <1, 1 - <5, 5 - <8, 8 - <18, 18+ in dia), `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 15. Number of live aspen stems per acre by diameter class (0 - <1, 1 - <5, 5 - <8, 8 - <18, 18+ in dia), `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 16. Basal area (square feet) per acre by forest type and stand age classes (up to 500 years in 20 year intervals), `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 17. Acres of forest by stand age class (up to 200 years in 5 year intervals) and forest type group, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
Table 18. Acres of forest by disturbance, `r AOInm`, `r toString(states)`, `r invyrs2`.
...
```
Figure 16. Acres of forest by disturbance, `r AOInm`, `r toString(states)`, `r invyrs2`.
