...
if (is.null(cfilter) && is.null(pfilter)) {
...
## Photo text
photo_text <- paste0("Photo from ", AOInm, title.states, ".")
...
estdat_EST7 <- modGBtree(GBpopdat=GBpopdat, landarea="FOREST", 
		...
		rowvar="FORTYPGRPCD", row.FIAname=TRUE,
		rawdata=TRUE, returntitle=TRUE, estround=2, pseround=0,
		divideby="million", title.filter=title.filter)
...
estdat_EST9_v1 <- modGBarea(GBpopdat=GBpopdat, landarea="FOREST", 
		...
		rawdata=TRUE, returntitle=TRUE, estround=2, pseround=0,
		title.rowvar="stand age class",	title.filter=title.filter,
		divideby="thousand")
...
estdat_EST10 <- modGBarea(GBpopdat=GBpopdat, landarea="FOREST", 
		...
		rawdata=TRUE, returntitle=TRUE, estround=2, pseround=0,
		title.filter=title.filter, divideby="thousand")
...
estdat_EST11_v2 <- modGBratio(GBpopdat=GBpopdat, landarea="FOREST",
    sumunits=TRUE, pfilter=pfilter, cfilter=cfilter, estseed="add",
		...
		rawdata=TRUE, returntitle=TRUE, estround=2, pseround=0,
		title.filter=title.filter, title.rowvar=paste("diameter class of", title.spcd))
...
estdat_EST14 <- modGBarea(GBpopdat=GBpopdat, landarea="FOREST", 
		...
		estround=2, pseround=0, title.filter=title.filter)
